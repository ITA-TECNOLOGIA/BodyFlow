...
from models.predictors_2d.lightweight.modules.keypoints import BODY_PARTS_KPT_IDS, BODY_PARTS_PAF_IDS
from models.predictors_2d.lightweight.modules.one_euro_filter import OneEuroFilter
