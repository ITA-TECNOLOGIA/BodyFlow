...
from models.predictors_3d.mixste.model_cross import *
...
class MixSTE(HPE3D):
    ...
    def __init__(self):   
        ...
        receptive_field = 243
        model_pos =  MixSTE2(num_frame=receptive_field, num_joints=17, in_chans=2, embed_dim_ratio=512, depth=8,
        ...
        chk_filename = 'models/checkpoint_cpn_243f.bin'
        ...
        self.model.eval() 
        self._args_3d = {'frames': receptive_field, 'num_joints': 17} 
